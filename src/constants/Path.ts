...
export const BASE_URL = 'https://routing-nearly-sponsorship-breakfast.trycloudflare.com';

export const SOCKET_BASE_URL = 'wss://routing-nearly-sponsorship-breakfast.trycloudflare.com/'
